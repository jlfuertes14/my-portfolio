...
// Skip intro if user has already entered during this session
if (sessionStorage.getItem('introEntered') === 'true') {
    if (overlay) {
        overlay.style.display = 'none';
    }
    // Don't add intro-active class, don't run the rest of the script
} else {
    // Only run intro if not already entered
...
} // End of else block for intro check
